...
export function artifactContextMessage(artifact) {
  ...
  return {
    ...
    content: [
      ...
      "Storage: internal handoff artifact; content is already embedded below. Do not use file tools to read artifact storage paths.",
      "Use this artifact content as the source of truth. Do not repeat the prior skill's work unless the user explicitly asks for a fresh review or the artifact is insufficient.",
      "Content:",
