...
- When starting a worker, pass the planned worker mode explicitly: research for read-only investigation, verify for command-based validation, or implement only for a narrow non-overlapping edit scope.
